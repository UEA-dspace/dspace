...
<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Serviços para o Autor<b class="caret"></b> </a>
            <ul class="dropdown-menu">
                ...
                <li><a href="http://repositorioinstitucional.uea.edu.br:8080/ficha/ficha_catalografica.php">Ficha Catalográfica</a> </li>
        ...
        <li><a href="<%= request.getContextPath() %>/feedback/form.jsp" locbar="commLink">Contato</a></li>
